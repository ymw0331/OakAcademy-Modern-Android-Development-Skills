                                        ...
                                        reference.child("Users").child(auth.getUid()).child("image").setValue(filePath)
                                                ...
                                                .addOnFailureListener(new OnFailureListener() {
                                                    ...
                                                    public void onFailure(@NonNull Exception e) {
                                                        Toast.makeText(SignUpActivity.this, "Write to database is not successful", Toast.LENGTH_LONG).show();
                                                    }
                                                });
                                    }
                                });
...
//                    intent.putExtra("userName", userName);
                    ...
                    Toast.makeText(SignUpActivity.this, "There is a problem", Toast.LENGTH_LONG).show();
                }
            }
        });
    }

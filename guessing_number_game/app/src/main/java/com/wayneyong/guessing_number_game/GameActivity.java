...
public class GameActivity extends AppCompatActivity {
    ...
    //keep user guesses in an arraylist
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (guess.equals("")) {
                    ...
                    userAttempts++;
                    //decrease value of remaining right, origin= 10
                    remainingRight--;

                    //convert guess value to integer type
                    int userGuess = Integer.parseInt(guess);
                    guessesList.add(userGuess);

                    //print user last guess and remaining right
                    textViewLast.setText("Your last guess is : " + guess);
                    textViewRight.setText("Your remaining guess is :" + remainingRight);

                    //compare randomly generated number with user guess
                    if (random == userGuess) {
                        ...
                        builder.setMessage("Congratulations. My guess was " + random
                                + "\n\n You know my number is in " + userAttempts
